...
const config = {
  scoreThreshold: 0.25,
  iouThreshold: 0.45,
  maxNumBoxes: 100, // bump this up (or to a very large number)
};
const configuration = {
  scoreThreshold: 0.5,
  iouThreshold: 0.5,
...
function LoadModelLocalPage() {
  ...
  const detectFrame = async () => {
    ...
    try {
      ...
      const predictions = await inferEngine.infer(modelWorkerId, img, config);
...
export default LoadModelLocalPage;
